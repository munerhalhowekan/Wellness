  ...
  <div class="form-container">
    ...
    <form action="admin-register.php" method="post">
      ...
      <div class="input-group">
          ...
          <small style="color:#aaa;">(8+ chars, Uppercase, Lowercase, Number, Symbol)</small>
      </div>
      <?php if (!empty($error_message)): ?><p style="color: red;"><?php echo $error_message; ?></p><?php endif; ?>
      <button type="submit" class="btn form-btn">Register</button>
    </form>
    <p class="login-text">Already have an account? <a href="admin-login.php">Login here</a></p>
  </div>
</body>
</html>